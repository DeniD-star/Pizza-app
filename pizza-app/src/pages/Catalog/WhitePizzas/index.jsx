...
const WhitePizzas = () => {
  const[cardsPizza, setCardsPiza] = useState([
    {id: 0, name: 'Delicata', imageUrl: 'https://www.kuokko.com/it/webservice/restaurant/get_image/11/fO96Xtj5hthvOKHyhMXe', ingredients: 'Mozzarella fior di latte, Spinaci, Zucchine, Funghi porcini', price: "8.00"},
    {id: 1, name: 'Partenopea', imageUrl: 'https://www.kuokko.com/it/webservice/restaurant/get_image/11/kdPOsMKT3Gnhz7zhGnaA', ingredients: 'Pomodorini salsati interi, Mozzarella di bufala d.o.p., Basilico', price: "7.00"},
    {id: 2, name: 'Primavera', imageUrl: 'https://www.kuokko.com/it/webservice/restaurant/get_image/11/KVvnJ5vbzTNKwyUwBVxQ', ingredients: 'Mozzarella fior di latte, Pomodorini, Rucola, Scaglie di parmigiano, Prosciutto crudo', price: "8.00"},
    {id: 3, name: 'Regina', imageUrl: 'https://www.kuokko.com/it/webservice/restaurant/get_image/11/DxTmVCJkOwGE0nwDRrxK', ingredients: 'Mozzarella di bufala d.o.p., Pomodorini, Basilico', price: "7.00"},
    {id: 4, name: 'Saporita', imageUrl: 'https://www.kuokko.com/it/webservice/restaurant/get_image/11/6HR0OAve6t6WcFaSWoRw', ingredients: 'Mozzarella fior di latte, Funghi, Salsiccia, Scamorza, Peperoncino', price: "6.50"},
    {id: 5, name: 'Spaccanapoli', imageUrl: 'https://www.kuokko.com/it/webservice/restaurant/get_image/11/00f9c18c6ee3c45350fd6c4d147d9e49', ingredients: "Mozzarella fior di latte, Patate novelle al forno, Porchetta, Funghi", price: "7.50"},
    {id: 6, name: 'Tokyo', imageUrl: 'https://www.kuokko.com/it/webservice/restaurant/get_image/11/ZZRm2RVCo4TZNs6E7Ino', ingredients: 'Prosciutto cotto, Funghi, Salsiccia, Panna', price: "7.50"},
    {id: 7, name: 'Vagdo', imageUrl: 'https://www.kuokko.com/it/webservice/restaurant/get_image/11/hhG8HwDCNDUpK0pRupa8', ingredients: 'Mozzarella fior di latte, Patate novelle al forno, Brie, Pesto fatto in casa, Porchetta', price: "8.50"},
  ])
